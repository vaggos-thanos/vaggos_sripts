...
var guildId = "950505236605321346"; // Guild ID for a Discord Server, see https://faxes.zone/i/zjKnd.png
var botToken = "MTAxNTk0ODM5OTk2MDQwODE2Ng.GdFTFs.1hOENlErQh6Cm3hqbVvxk3flkAU1zgAM4OIn3A"; // This must be a Discord bot token, create a bot @ https://discord.com/developers/applications
        ...
        setTimeout(async function() {
            getUserDiscord(src, async function(userId) {
                if(userId) {
                    ...
                    return deferrals.done(`Your Discord credentials were not detected. See this link for some tips to get it detected `);
                }
            });
        }, 0)
    }, 0)
